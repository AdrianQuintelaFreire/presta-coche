            ...
            <div class="cars-container">
                ...
                <article class="car-card">
                    ...
                    <div class="car-card__image-wrapper">
                        <img src="../storage/cars/<?= htmlspecialchars($v['foto']) ?>"
                    ...
                    <div class="car-card__content">
                        ...
                        <?php if ($estado === 'validado'): ?>
                            ...
                            <button type="button" class="car-card__button car-card__button--availability open-availability-modal"
    ...
    <div class="modal__content">
        ...
        <form action="/prestacoche/actions/update-vehicle.php" method="POST" class="modal-form">
            ...
            <div class="modal-form__group">
                ...
                <input type="number" step="0.01" name="precio_km" id="editPrecioKm" class="modal-form__input" required>
